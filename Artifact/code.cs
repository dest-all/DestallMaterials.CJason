...
2 => json.RemoveArray((JsonPiece json_j, out SampleNamespace.Child children_i) => { var r = json_j.RemoveObject(out children_i); return r; }, out children),
3 => json.RemoveArray((JsonPiece json_j, out System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, SampleNamespace.Child[]>>[][][] complaints_i) => { var r = json_j.RemoveArray((JsonPiece json_j_j, out System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, SampleNamespace.Child[]>>[][] complaints_i_i) => { var r = json_j_j.RemoveArray((JsonPiece json_j_j_j, out System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, SampleNamespace.Child[]>>[] complaints_i_i_i) => { var r = json_j_j_j.RemoveArray((JsonPiece json_j_j_j_j, out System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, SampleNamespace.Child[]>> complaints_i_i_i_i) => { var r = json_j_j_j_j.RemoveDictionary( 
(JsonPiece json_j_j_j_j_j, out string complaints_i_i_i_i_v) => { var r = json_j_j_j_j_j.RemoveQuotedValue(j => new string(j), out complaints_i_i_i_i_v); return r; },
(JsonPiece json_j_j_j_j_j, out System.Collections.Generic.Dictionary<string, SampleNamespace.Child[]> complaints_i_i_i_i_v) => { var r = json_j_j_j_j_j.RemoveDictionary( 
(JsonPiece json_j_j_j_j_j_j, out string complaints_i_i_i_i_v_v) => { var r = json_j_j_j_j_j_j.RemoveQuotedValue(j => new string(j), out complaints_i_i_i_i_v_v); return r; },
(JsonPiece json_j_j_j_j_j_j, out SampleNamespace.Child[] complaints_i_i_i_i_v_v) => { var r = json_j_j_j_j_j_j.RemoveArray((JsonPiece json_j_j_j_j_j_j_j, out SampleNamespace.Child complaints_i_i_i_i_v_v_i) => { var r = json_j_j_j_j_j_j_j.RemoveObject(out complaints_i_i_i_i_v_v_i); return r; }, out complaints_i_i_i_i_v_v); return r; }, 
out complaints_i_i_i_i_v); return r; }, 
out complaints_i_i_i_i); return r; }, out complaints_i_i_i); return r; }, out complaints_i_i); return r; }, out complaints_i); return r; }, out complaints),
4 => json.RemoveDictionary( 
(JsonPiece json_j, out string priorities_v) => { var r = json_j.RemoveQuotedValue(j => new string(j), out priorities_v); return r; },
(JsonPiece json_j, out System.Collections.Generic.Dictionary<string, System.Collections.Generic.Dictionary<string, SampleNamespace.Child[]>> priorities_v) => { var r = json_j.RemoveDictionary( 
(JsonPiece json_j_j, out string priorities_v_v) => { var r = json_j_j.RemoveQuotedValue(j => new string(j), out priorities_v_v); return r; },
(JsonPiece json_j_j, out System.Collections.Generic.Dictionary<string, SampleNamespace.Child[]> priorities_v_v) => { var r = json_j_j.RemoveDictionary( 
(JsonPiece json_j_j_j, out string priorities_v_v_v) => { var r = json_j_j_j.RemoveQuotedValue(j => new string(j), out priorities_v_v_v); return r; },
(JsonPiece json_j_j_j, out SampleNamespace.Child[] priorities_v_v_v) => { var r = json_j_j_j.RemoveArray((JsonPiece json_j_j_j_j, out SampleNamespace.Child priorities_v_v_v_i) => { var r = json_j_j_j_j.RemoveObject(out priorities_v_v_v_i); return r; }, out priorities_v_v_v); return r; }, 
out priorities_v_v); return r; }, 
out priorities_v); return r; }, 
out priorities),
5 => json.RemoveDictionary( 
